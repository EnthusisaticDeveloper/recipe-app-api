...
class PublicUserApiTests(TestCase):
    ...
    # authentication required on an endpoint
...
# Authentication required before using these endpoints
class PrivateUserApiTests(TestCase):
    """Test API requests that require authentication"""

    def setUp(self) -> None:
        self.user = create_user(
            email='test@kazang.com',
            password='testpass',
            name='Test User',
        )
        self.client = APIClient()
    ...
    def test_update_user_profile(self):
        ...
        # helper fn to update the user with latest value in db
